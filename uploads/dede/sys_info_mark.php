...
if($action=="save")
{
    $vars = array('photo_markup','photo_markdown','photo_marktype','photo_wwidth','photo_wheight','photo_waterpos','photo_watertext','photo_titletext','photo_fontsize','photo_fontcolor','photo_fontbackground','photo_fontpadding','photo_marktrans','photo_diaphaneity');
    $configstr = $shortname = "";
    foreach($vars as $v)
    {
