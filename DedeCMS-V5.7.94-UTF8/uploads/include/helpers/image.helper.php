...
if ( ! function_exists('ImageResize'))
{
    function ImageResize($srcFile, $toW, $toH, $toFile="")
    {
        ...
        if(function_exists("imagecreateTRUEcolor"))
        {
            ...
            $bg =imagecolorallocatealpha($ni, 255, 255, 255, 127);
            imagefill($ni, 0, 0, $bg);
...
if ( ! function_exists('WaterImg'))
{
    function WaterImg($srcFile, $fromGo='up')
    {
        ...
        if (isset($_SESSION['needwatermarkup'])) {
            $photo_markup = $_SESSION['needwatermarkup'];
            unset($_SESSION['needwatermarkup']);
        }
        if (isset($_SESSION['needwatermarkdown'])) {
            $photo_markdown = $_SESSION['needwatermarkdown'];
        ...
        if ($photo_titletext == "1" && !empty($_SESSION['photo_watertext'])) {
            $cfg_watermarktext['text'] = $_SESSION['photo_watertext'];
        } else {
        ...
        $cfg_watermarktext['background'] = $photo_fontbackground;
        $cfg_watermarktext['padding'] = $photo_fontpadding;
