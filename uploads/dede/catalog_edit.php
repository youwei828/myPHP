...
if($dopost=="save")
{
    ...
    $upquery = "UPDATE `#@__arctype` SET
     ...
     sortrank='$sortrank',
     typename='$typename',
     typeenglishname='$typeenglishname',
     typebigimg='$typebigimg',
     typesmallimg='$typesmallimg',
     typedir='$typedir',
     isdefault='$isdefault',
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
       <tr> 
         ...
         <tr> 
          ...
          <tr> 
            <td class='bline' height="26" align="center"><font color='red'>栏目中文名称：</font></td>
            <td class='bline'><input name="typename" type="text" id="typename" size="30" value="<?php echo $myrow['typename']?>" class="iptxt" /></td>
          </tr>
          <tr>
            <td class='bline' height="26" align="center"><font color='red'>栏目英文名称：</font></td>
            <td class='bline'>
